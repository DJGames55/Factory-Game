...
public class UIReader : MonoBehaviour
{
    ...
    {
        pauseBackground = ui.Q<VisualElement>("PauseBackground");
        ...
        //Options
        sensLable = ui.Q<Label>("SliderLabel");
        sensSlider = ui.Q<SliderInt>("SensSlider");
        ...
        //HUD
        //Action Prompt
        actionPrompt = ui.Q<Label>("ActionPrompt");
    }
