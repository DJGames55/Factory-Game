...
public class Building : MonoBehaviour
{
    ...
    ***/
    ...
    public Vector3Int WorldToGridPosition(Vector3 worldPosition, Grid grid)
    {
        ...
        // Adjust the world position to account for non-uniform cell size
        Vector3 adjustedPosition = new Vector3(worldPosition.x / cellSize.x, worldPosition.y / cellSize.y, worldPosition.z / cellSize.z);

        // Convert the adjusted position to grid cell position
        Vector3Int gridPosition = new Vector3Int(Mathf.FloorToInt(adjustedPosition.x), Mathf.FloorToInt(adjustedPosition.y), Mathf.FloorToInt(adjustedPosition.z));
