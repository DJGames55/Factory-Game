...
public class Building : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            objectBlueprint.transform.position = new Vector3((float)(gridPosition.x + 0.5), objectBlueprint.gameObject.GetComponent<ObjectType>().objectHeight, (float)(gridPosition.z + 0.5));
        }
    }
