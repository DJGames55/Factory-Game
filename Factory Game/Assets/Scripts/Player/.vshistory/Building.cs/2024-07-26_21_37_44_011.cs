...
public class Building : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 scaledPosition = new Vector3(mousePosition.x, mousePosition.y / 0.5f, mousePosition.z); // Scale the y-coordinate
        Vector3Int gridPosition = grid.WorldToCell(scaledPosition);
