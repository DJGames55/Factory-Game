...
public class Interact : MonoBehaviour
{
    ...
    public void HandleInteract()
    {
        if (heldObject != null)
        {
            _UIReader.actionPrompt.style.display = DisplayStyle.None;
        ...
        {
            _UIReader.actionPrompt.style.display = DisplayStyle.Flex;
            _UIReader.actionPrompt.text = "E To Drop";
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            _UIReader.actionPrompt.style.display = DisplayStyle.Flex;
            _UIReader.actionPrompt.text = "Press E To Pick Up";
