...
public class Interact : MonoBehaviour
{
    ...
    private void HandleInteract()
    {
        if (heldObject != null)
        {
            ...
            heldObject.GetComponent<Rigidbody>().mass = heldObjMass;
            heldObject = null;
            pickUpCam.SetActive(false);
        ...
        { 
            ...
            heldObjMass = heldObject.GetComponent<Rigidbody>().mass;
            heldObject.GetComponent<Rigidbody>().mass = 0f;
