...
public class InputReader : ScriptableObject, GameInput.IGameplayActions, GameInput.IUIActions, GameInput.IBuildActions
{
    ...
    public event Action EndSprintEvent;
    public void OnSprint(InputAction.CallbackContext context)
    {
        if (context.phase == InputActionPhase.Started) { StartSprintEvent?.Invoke(); }
        else if (context.phase == InputActionPhase.Canceled) { EndSprintEvent?.Invoke(); }
    }
